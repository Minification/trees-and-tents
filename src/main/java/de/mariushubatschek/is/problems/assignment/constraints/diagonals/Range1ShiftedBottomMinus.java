...
public class Range1ShiftedBottomMinus extends AbstractBinaryConstraint {

    public Range1ShiftedBottomMinus(Variable v1, Variable v2) {
        super(v1, v2);
    }

    @Override
    protected boolean implementation(int value1, int value2) {
        return !(value1 == 2 && value2 == -2) && !(value1 == -1 && value2 == -2) && !(value1 == 2 && value2 == 1);
    }
}
