...
public class Range1ShiftedLeftMinus extends AbstractBinaryConstraint {
    public Range1ShiftedLeftMinus(Variable v1, Variable v2) {
        super(v1, v2);
    }

    @Override
    protected boolean implementation(int value1, int value2) {
        return !(value1 == 2 && value2 == 1) && !(value1 == -1 && value2 == 1) && !(value1 == -1 && value2 == -2);
    }
}
